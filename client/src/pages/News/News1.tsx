...
const News1 = () => {
    return (
        <div className="article">
            <h1>Dấu Hiệu Nhận Biết Đột Quỵ</h1>
            <p>
                <i>
                    Đột quỵ hay còn gọi là tai biến mạch máu não là nguyên nhân gây tử vong thứ 2 trên thế giới. Đột quỵ thường có thể xảy ra ở bất cứ thời điểm nào nên nếu không được cấp cứu kịp thời sẽ dẫn đến những di chứng không thể phục hồi, thậm chí là tử vong, tạo gánh nặng về kinh tế cho cả gia đình và xã hội. Vì vậy, nhận biết sớm dấu hiệu của đột quỵ để có thể xử lý và cấp cứu kịp thời là vô cùng quan trọng
                </i>
            </p>

            <h5>Đột quỵ để lại di chứng nặng nề</h5>
            <p>
                Đột quỵ là một bệnh lý gây tổn thương nghiêm trọng cho não bộ. Nguyên nhân xuất phát từ sự gián đoạn việc vận chuyển máu nuôi dưỡng não bộ do mạch máu bị tắc nghẽn hay bị vỡ.
            </p>

            <img src="https://dotquy.kcb.vn/upload/2005307/fck/files/clip_image002_9a65e.jpg" alt="" />

            <p>Có 2 loại đột quỵ:</p>
            ...
            <img src="https://dotquy.kcb.vn/upload/2005307/fck/files/clip_image004_a5962.jpg" alt="" />
            <h5>
                Dấu hiệu nhận biết đột quỵ
            </h5>
            <p>
                Mỗi năm nước ta có khoảng 200.000 trường hợp bị đột quỵ với tỷ lệ tử vong từ 10-20%. Trong đó, cứ 4 ca bị đột quỵ chỉ có 1 ca là bệnh nhân có thể độc lập đi lại. Bởi vậy, việc nhận biết sớm các triệu chứng của đột quỵ là vô cùng quan trọng, để cấp cứu kịp thời và có tác động quan trọng trong phục hồi sau đột quỵ của bệnh nhân.
            </p>
            <h5>
                Các dấu hiệu để nhận biết người bị đột quỵ, bao gồm:
            </h5>
            <ul>
                <li>
            ...
            <img src="https://dotquy.kcb.vn/upload/2005307/fck/files/clip_image006_d596a.jpg" alt="" />
            <p>
                Người bị đột quỵ có thể có một vài hoặc tất cả các dấu hiệu trên. Vì vậy bạn phải chú ý các biểu hiện của người bị đột quỵ để đưa đi cấp cứu kịp thời, tránh bỏ xót dẫn đến những hậu quả đáng tiếc.
            </p>
            <h5>Cấp cứu đột quỵ: Thời gian là mạng sống</h5>
            <p>
            ...
            <p>
                Đề phòng nguy cơ đột quỵ để giữ sức khỏe cho cả cộng đồng là việc không của riêng ai, bạn hãy hành động thiết thực bằng cách chia sẻ ngay những thông tin cần thiết để ngăn ngừa đột quỵ trên website: dotquy.kcb.vn và Fanpage Facebook Phòng chống đột quỵ tới tất cả mọi người.
            </p>


            <div className="source">
                <span>
                    <a href="https://dotquy.kcb.vn/hieu-dung-ve-dot-quy/dau-hieu-nhan-biet-dot-quy.html">Trích Bộ y tế</a>
                </span>
