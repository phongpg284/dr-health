...
export class Migration20220614090527 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "medical_stat" alter column "unit" type varchar(255) using ("unit"::varchar(255));');
    this.addSql('alter table "medical_stat" alter column "unit" drop not null;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "medical_stat" alter column "unit" type varchar(255) using ("unit"::varchar(255));');
    this.addSql('alter table "medical_stat" alter column "unit" set not null;');
    this.addSql('alter table "medical_stat" drop constraint "medical_stat_pkey";');
