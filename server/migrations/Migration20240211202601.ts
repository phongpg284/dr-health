...
export class Migration20240211202601 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "patient" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "code" varchar(255) null default \'8bn0rt4q\', "account_id" int not null, "doctor_id" int null, "device_id" int null, "medical_threshold_id" int null);');
    ...
    this.addSql('create table "medical_record" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "patient_id" int not null, "blood_test_id" int not null, "supersonic_test_id" int not null, "urine_test_id" int not null, "device_record_id" int not null);');
