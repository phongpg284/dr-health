...
function GreetingBot(): ReactElement {
    ...
    return (
        <>
            <div ref={checkerRef} className="checker">
            ...
            <motion.div
                ...
                initial={position}
                animate={position}
                transition={{ type: "tween", duration: isDrag ? 0.05 : 0.4 }}
                className="greeting_bot_container">
                ...
                <div className={`message_wrapper ${isLeft ? "left" : "right"}`}>
                    {
                        (messageAvailable && enableBot && currentData != null && enableChat) && (enableLoop || currentData?.repeat <= 1) &&
                ...
                <div className="greeting_bot_wrapper">
                    {
                        currentData && enableBot && (mp3 != null) && enableSound && (enableLoop || currentData?.repeat <= 1) &&
                        <audio key={mp3} src={mp3} autoPlay >
                    ...
                    <div ref={botContainerRef} className="bot_container">
                        ...
                        <div
                            onClick={toggleMenu}
                            className="bot_avatar_container">
