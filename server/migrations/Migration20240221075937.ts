...
export class Migration20240221075937 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "patient" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "code" varchar(255) null default \'wgza82fc\', "account_id" int not null, "doctor_id" int null, "device_id" int null, "medical_threshold_id" int null);');
    ...
    this.addSql('alter table "user" add constraint "user_patient_id_foreign" foreign key ("patient_id") references "patient" ("id") on update cascade on delete set null;');
    this.addSql('alter table "user" add constraint "user_doctor_id_foreign" foreign key ("doctor_id") references "doctor" ("id") on update cascade on delete set null;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "user" drop constraint "user_doctor_id_foreign";');
    ...
    this.addSql('alter table "user" drop constraint "user_patient_id_foreign";');
