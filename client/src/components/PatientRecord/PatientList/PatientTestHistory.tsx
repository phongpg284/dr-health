...
//                     <DropdownButton
//                         variant="light"
//                         title={dayjs(new Date(chosenTest.updatedAt)).format("HH:mm - DD/MM/YYYY")}
...
//                                     {dayjs(new Date(test.updatedAt)).format("HH:mm - DD/MM/YYYY")}
//                                 </Dropdown.Item>
//                             ))
//                         }
//                         <Dropdown.Divider />
...
function TestContent({ test }: TestContent) {
  ...
  return (
    <div className="test_content">
      <div className="nameSpace">Nội dung khám</div>
      <div className="questions">
        <table>
          ...
          <tbody>
            ...
            <tr>
              <th colSpan={3}>Tổng điểm {totalPoint}</th>
            </tr>
          </tbody>
        </table>
      </div>
      <div className="totalPoint"></div>
    </div>
  );
}
...
function Question({ question }: Question) {
  ...
  return (
    <tr className="question">
      ...
      <td className="option">{options[point]}</td>
