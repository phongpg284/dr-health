            ...
            <div className="dataPicker">
                ...
                <div className="pickerItem">
                    ...
                    <RangePicker
                        ...
                        className="calendar_range_picker_item calendar_rounded" />
                </div>
                <div className="pickerItem" >
                    ...
                    <InputNumber
                        ...
                        className="calendar_number_picker_item calendar_rounded" />
                </div>
                <div className="pickerItem" >
        ...
        <>
            {
                arrHours.map((hour, index) => (
                    <div className="pickerItem" key={index}>
                        ...
                        <TimePicker
                            defaultValue={moment(defaultDate.toISOString())}
                            key={index}
                            onChange={(value) => onHoursChange(value, index)}
